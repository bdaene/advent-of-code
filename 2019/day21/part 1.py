...
def solve(int_program):
    ...
    def input_func():
        for command in ascii_program:
            print(command)
            yield command

    execute_ascii(int_program, input_func=input_func().__next__)


if __name__ == "__main__":
    with open('input.txt', 'r') as input_file:
        int_program = list(map(int, input_file.readline().split(',')))
    print(solve(int_program))
